            ...
            <form enctype="multipart/form-data" action="" method="post">
                <div class="modal-body">
                    <div class="picture-wrapper text-center">
                        <div id="modal-profile-pic-div" class="image-div lg mx-auto <?= !isset($user['photo']) ? 'd-none' : '' ?>" data-image="../assets/images/<?= isset($user['photo']) ? $user['photo'] : '' ?>"></div>
                        <div id="text-profile-pic" class="text-profile-pic <?= isset($user['photo']) ? 'd-none' : '' ?> mx-auto photo lg bg-secondary border-light border-3 border text-light ">
                ...
                <div class="modal-footer justify-between d-flex">
                    ...
                    <button type="submit" name="change-photo" class="btn btn-light-green fw-medium ms-auto">Save changes</button>
                </div>
            </form>
        </div>
    </div>

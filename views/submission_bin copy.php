        ...
        <div class="content">
            ...
            <div class="mt-4">
                ...
                <div class="row mt-1 gy-2">
                        ...
                        <div class="card border shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    ...
                                    <button id="add-comment-btn" class="btn-link link-success text-decoration-none btn p-0 border-0">
                                        Add private comment
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 ms-auto order-0 order-lg-1">
                        <div class="card border shadow-sm">
                            <div class="card-body">
            ...
            return `
                    <div class="comment-row">
                        <div class="d-flex">
                            ...
                            <div>
                                <p class="mb-1">${data.name} <span class="text-sm fw-light text-black-50">${data.time}</span></p>
                                <p class="text-sm text-secondary fw-light mb-1">${data.is_admin?'Admin':'Scholar'}</p>
                                <p>${data.message}</p>
                            </div>
                        </div>
                    </div>

...
<body class="bg-light">
                ...
                <div class="container-fluid mb-4">
                    ...
                    <div class="row gy-5">
                        ...
                        <div class="col-md-4 mb-2">
                            <p class="fw-normal fs-6 mt-3 text-primary">BNS Status</p>
                            <div class="d-flex align-items-center">
                                <span class="bullet bg-primary me-2 rounded-circle"></span>
                                <p class="text-primary fw-medium my-0">
                                    <small>Today</small>
                                </p>
                            </div>
                            <!-- header -->
                            <div class="attendance-wrapper">
                                <div class="row mt-3 gx-1 mb-1">
                                    ...
                                    <div class="col-3">
                                        <div class="p-2 h-100 align-items-center d-flex flex-column justify-content-center align-items-center text-white bg-light-danger text-center">
                                            <i class="bx bx-time"></i>
                                            <p class=" mb-0"><small class="fw-medium">Status</small></p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function getScholarStatus() {
            $.get('../app/get_scholar_status.php',
                (res) => {
                    $("#status-wrapper").html('');
                    for (data of res) {
                        let row = `<div class="row gx-1 mb-1">
                                        <div class="col-3">
                                            <div class="bg-light border p-2 text-center">
                                            <div id="profile-pic-div" class="image-div sm mx-auto" data-image="../../assets/images/${data.photo}"></div>
                                                <p class="my-1">
                                        ...
                                        <div class="col">
                                            <div class="bg-light border p-2 text-center h-100 d-flex justify-content-center align-items-center">
                                                <small class="fw-medium">${data.online? 'Online':'Offline'}</small>
                                            </div>
                                        </div>
                                    </div>`

                        $("#status-wrapper").append(row);
                    }
                    loadProfilePhotos();
